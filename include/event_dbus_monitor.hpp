...
inline void hostStatePropertyChange(sdbusplus::message::message& msg)
{
    ...
    if (type != nullptr)
    {
        if (*type == "xyz.openbmc_project.State.Host.HostState.Off")
        {
            ...
            // TODO crow::obmc_dump::resetHandlers();
...
inline void registerHostStateChangeSignal()
{
...
inline void registerBMCStateChangeSignal()
{
...
inline void registerVMIIPEnabledPropChangeSignal()
{
...
inline void registerVMIIPChangeSignal()
{
...
inline void registerVMIEthIntfPropChangeSignal()
{
...
inline void registerBootProgressChangeSignal()
{
...
inline void registerEventLogCreatedSignal()
{
...
inline void registerPostCodeChangeSignal()
{
...
inline void registerDumpCreatedSignal()
{
...
inline void registerDumpDeletedSignal()
{
...
inline void registerDumpUpdateSignal()
{
...
inline void registerBIOSAttrUpdateSignal()
{
...
inline void registerSAIStateChangeSignal()
{
    BMCWEB_LOG_DEBUG(
