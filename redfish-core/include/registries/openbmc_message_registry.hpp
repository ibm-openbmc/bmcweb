...
enum class Index
{
    ...
    bIOSPOSTCode = 17,
    bIOSPOSTError = 18,
    bIOSRecoveryComplete = 19,
    bIOSRecoveryStart = 20,
    bMCBootReason = 21,
    bMCFirmwarePanicReason = 22,
    bMCFirmwareRecoveryReason = 23,
    bMCFirmwareResiliencyError = 24,
    bMCKernelPanic = 25,
    cPLDFirmwarePanicReason = 26,
    cPLDFirmwareRecoveryReason = 27,
    cPLDFirmwareResiliencyError = 28,
    cPUError = 29,
    cPUMismatch = 30,
    cPUThermalTrip = 31,
    chassisIntrusionDetected = 32,
    chassisIntrusionReset = 33,
    componentOverTemperature = 34,
    dCPowerOff = 35,
    dCPowerOn = 36,
    driveError = 37,
    eventLogCleared = 38,
    fanInserted = 39,
    fanRedundancyLost = 40,
    fanRedundancyRegained = 41,
    fanRemoved = 42,
    firmwareActivationCompleted = 43,
    firmwareActivationFailed = 44,
    firmwareActivationStarted = 45,
    firmwareResiliencyError = 46,
    firmwareUpdateCompleted = 47,
    firmwareUpdateFailed = 48,
    firmwareUpdateStaged = 49,
    firmwareUpdateStarted = 50,
    generalFirmwareSecurityViolation = 51,
    iPMIWatchdog = 52,
    intelUPILinkWidthReducedToHalf = 53,
    intelUPILinkWidthReducedToQuarter = 54,
    invalidLoginAttempted = 55,
    invalidUpload = 56,
    inventoryAdded = 57,
    inventoryRemoved = 58,
    lanLost = 59,
    ...
    legacyPCIPERR = 61,
    legacyPCISERR = 62,
    mEAutoConfigFailed = 63,
    mEAutoConfigSuccess = 64,
    mEBootGuardHealthEvent = 65,
    mECpuDebugCapabilityDisabled = 66,
    mEDirectFlashUpdateRequested = 67,
    mEExceptionDuringShutdown = 68,
    mEFactoryResetError = 69,
    mEFactoryRestore = 70,
    mEFirmwareException = 71,
    mEFirmwarePanicReason = 72,
    mEFirmwareRecoveryReason = 73,
    mEFirmwareResiliencyError = 74,
    mEFlashEraseError = 75,
    mEFlashStateInformation = 76,
    mEFlashStateInformationWritingEnabled = 77,
    mEFlashVerificationError = 78,
    mEFlashWearOutWarning = 79,
    mEImageExecutionFailed = 80,
    mEInternalError = 81,
    mEManufacturingError = 82,
    mEMctpInterfaceError = 83,
    mEMultiPchModeMisconfig = 84,
    mEPeciOverDmiError = 85,
    mEPttHealthEvent = 86,
    mERecoveryGpioForced = 87,
    mERestrictedMode = 88,
    mESmbusLinkFailure = 89,
    mEUmaError = 90,
    mEUnsupportedFeature = 91,
    manufacturingModeEntered = 92,
    manufacturingModeExited = 93,
    memoryECCCorrectable = 94,
    memoryECCUncorrectable = 95,
    memoryParityCommandAndAddress = 96,
    memoryParityNotKnown = 97,
    memoryRASConfigurationDisabled = 98,
    memoryRASConfigurationEnabled = 99,
    memoryRASModeDisabled = 100,
    memoryRASModeEnabled = 101,
    memoryThermTrip = 102,
    mirroringRedundancyDegraded = 103,
    mirroringRedundancyFull = 104,
    nMIButtonPressed = 105,
    nMIDiagnosticInterrupt = 106,
    pCIeCorrectableAdvisoryNonFatal = 107,
    pCIeCorrectableBadDLLP = 108,
    pCIeCorrectableBadTLP = 109,
    pCIeCorrectableHeaderLogOverflow = 110,
    pCIeCorrectableInternal = 111,
    pCIeCorrectableLinkBWChanged = 112,
    pCIeCorrectableReceiverError = 113,
    pCIeCorrectableReplayNumRollover = 114,
    pCIeCorrectableReplayTimerTimeout = 115,
    pCIeCorrectableUnspecifiedAERError = 116,
    pCIeFatalACSViolation = 117,
    pCIeFatalAtomicEgressBlocked = 118,
    pCIeFatalCompleterAbort = 119,
    pCIeFatalCompletionTimeout = 120,
    pCIeFatalDataLinkLayerProtocol = 121,
    pCIeFatalECRCError = 122,
    pCIeFatalFlowControlProtocol = 123,
    pCIeFatalMCBlockedTLP = 124,
    pCIeFatalMalformedTLP = 125,
    pCIeFatalPoisonedTLP = 126,
    pCIeFatalReceivedErrNonFatalMessage = 127,
    pCIeFatalReceivedFatalMessageFromDownstream = 128,
    pCIeFatalReceiverBufferOverflow = 129,
    pCIeFatalSurpriseLinkDown = 130,
    pCIeFatalTLPPrefixBlocked = 131,
    pCIeFatalUncorrectableInternal = 132,
    pCIeFatalUnexpectedCompletion = 133,
    pCIeFatalUnspecifiedNonAERFatalError = 134,
    pCIeFatalUnsupportedRequest = 135,
    powerButtonLongPressed = 136,
    powerButtonPressed = 137,
    powerRestorePolicyApplied = 138,
    powerSupplyConfigurationError = 139,
    powerSupplyConfigurationErrorRecovered = 140,
    powerSupplyFailed = 141,
    powerSupplyFailurePredicted = 142,
    powerSupplyFanFailed = 143,
    powerSupplyFanRecovered = 144,
    powerSupplyInserted = 145,
    powerSupplyPowerGoodFailed = 146,
    powerSupplyPowerLost = 147,
    powerSupplyPowerRestored = 148,
    powerSupplyPredictedFailureRecovered = 149,
    powerSupplyRecovered = 150,
    powerSupplyRemoved = 151,
    powerUnitDegradedFromNonRedundant = 152,
    powerUnitDegradedFromRedundant = 153,
    powerUnitNonRedundantFromInsufficient = 154,
    powerUnitNonRedundantInsufficient = 155,
    powerUnitNonRedundantSufficient = 156,
    powerUnitRedundancyDegraded = 157,
    powerUnitRedundancyLost = 158,
    powerUnitRedundancyRegained = 159,
    resetButtonPressed = 160,
    sELEntryAdded = 161,
    securityBoot2ndFlashEnabled = 162,
    securityP2aBridgeEnabled = 163,
    securityUartPortDebugEnabled = 164,
    securityUserNonRootUidZeroAssigned = 165,
    securityUserNonRootUidZeroRemoved = 166,
    securityUserRootDisabled = 167,
    securityUserRootEnabled = 168,
    securityUserStrongHashAlgoRestored = 169,
    securityUserUnsupportedShellEnabled = 170,
    securityUserUnsupportedShellRemoved = 171,
    securityUserWeakHashAlgoEnabled = 172,
    sensorThresholdCriticalHighGoingHigh = 173,
    sensorThresholdCriticalHighGoingLow = 174,
    sensorThresholdCriticalLowGoingHigh = 175,
    sensorThresholdCriticalLowGoingLow = 176,
    sensorThresholdWarningHighGoingHigh = 177,
    sensorThresholdWarningHighGoingLow = 178,
    sensorThresholdWarningLowGoingHigh = 179,
    sensorThresholdWarningLowGoingLow = 180,
    serviceFailure = 181,
    serviceStarted = 182,
    sparingRedundancyDegraded = 183,
    sparingRedundancyFull = 184,
    ssbThermalTrip = 185,
    systemInterfaceDisabledProvisioned = 186,
    systemInterfaceUnprovisioned = 187,
    systemInterfaceWhitelistProvisioned = 188,
    systemPowerGoodFailed = 189,
    systemPowerLost = 190,
    systemPowerOffFailed = 191,
    systemPowerOnFailed = 192,
    voltageRegulatorOverheated = 193,
};
} // namespace redfish::registries::openbmc
