...
enum class Index
{
    ...
    hardwareIsolationReason = 50,
    iPMIWatchdog = 51,
    intelUPILinkWidthReducedToHalf = 52,
    intelUPILinkWidthReducedToQuarter = 53,
    invalidLoginAttempted = 54,
    invalidUpload = 55,
    inventoryAdded = 56,
    inventoryRemoved = 57,
    lanLost = 58,
    ...
    legacyPCIPERR = 60,
    legacyPCISERR = 61,
    mEAutoConfigFailed = 62,
    mEAutoConfigSuccess = 63,
    mEBootGuardHealthEvent = 64,
    mECpuDebugCapabilityDisabled = 65,
    mEDirectFlashUpdateRequested = 66,
    mEExceptionDuringShutdown = 67,
    mEFactoryResetError = 68,
    mEFactoryRestore = 69,
    mEFirmwareException = 70,
    mEFirmwarePanicReason = 71,
    mEFirmwareRecoveryReason = 72,
    mEFirmwareResiliencyError = 73,
    mEFlashEraseError = 74,
    mEFlashStateInformation = 75,
    mEFlashStateInformationWritingEnabled = 76,
    mEFlashVerificationError = 77,
    mEFlashWearOutWarning = 78,
    mEImageExecutionFailed = 79,
    mEInternalError = 80,
    mEManufacturingError = 81,
    mEMctpInterfaceError = 82,
    mEMultiPchModeMisconfig = 83,
    mEPeciOverDmiError = 84,
    mEPttHealthEvent = 85,
    mERecoveryGpioForced = 86,
    mERestrictedMode = 87,
    mESmbusLinkFailure = 88,
    mEUmaError = 89,
    mEUnsupportedFeature = 90,
    manufacturingModeEntered = 91,
    manufacturingModeExited = 92,
    memoryECCCorrectable = 93,
    memoryECCUncorrectable = 94,
    memoryParityCommandAndAddress = 95,
    memoryParityNotKnown = 96,
    memoryRASConfigurationDisabled = 97,
    memoryRASConfigurationEnabled = 98,
    memoryRASModeDisabled = 99,
    memoryRASModeEnabled = 100,
    memoryThermTrip = 101,
    mirroringRedundancyDegraded = 102,
    mirroringRedundancyFull = 103,
    nMIButtonPressed = 104,
    nMIDiagnosticInterrupt = 105,
    pCIeCorrectableAdvisoryNonFatal = 106,
    pCIeCorrectableBadDLLP = 107,
    pCIeCorrectableBadTLP = 108,
    pCIeCorrectableHeaderLogOverflow = 109,
    pCIeCorrectableInternal = 110,
    pCIeCorrectableLinkBWChanged = 111,
    pCIeCorrectableReceiverError = 112,
    pCIeCorrectableReplayNumRollover = 113,
    pCIeCorrectableReplayTimerTimeout = 114,
    pCIeCorrectableUnspecifiedAERError = 115,
    pCIeFatalACSViolation = 116,
    pCIeFatalAtomicEgressBlocked = 117,
    pCIeFatalCompleterAbort = 118,
    pCIeFatalCompletionTimeout = 119,
    pCIeFatalDataLinkLayerProtocol = 120,
    pCIeFatalECRCError = 121,
    pCIeFatalFlowControlProtocol = 122,
    pCIeFatalMCBlockedTLP = 123,
    pCIeFatalMalformedTLP = 124,
    pCIeFatalPoisonedTLP = 125,
    pCIeFatalReceivedErrNonFatalMessage = 126,
    pCIeFatalReceivedFatalMessageFromDownstream = 127,
    pCIeFatalReceiverBufferOverflow = 128,
    pCIeFatalSurpriseLinkDown = 129,
    pCIeFatalTLPPrefixBlocked = 130,
    pCIeFatalUncorrectableInternal = 131,
    pCIeFatalUnexpectedCompletion = 132,
    pCIeFatalUnspecifiedNonAERFatalError = 133,
    pCIeFatalUnsupportedRequest = 134,
