...
constexpr std::array registry =
{
    ...
    MessageEntry{
        "GardRecord",
        {
            "Indicates this resource is isolated.",
            "%1 Gard Record %2",
            "OK",
            2,
            {
...
enum class Index
{
    ...
    gardRecord = 52,
    generalFirmwareSecurityViolation = 53,
    hardwareIsolationReason = 54,
    iPMIWatchdog = 55,
    intelUPILinkWidthReducedToHalf = 56,
    intelUPILinkWidthReducedToQuarter = 57,
    invalidLoginAttempted = 58,
    invalidUpload = 59,
    inventoryAdded = 60,
    inventoryRemoved = 61,
    lanLost = 62,
    ...
    legacyPCIPERR = 64,
    legacyPCISERR = 65,
    mEAutoConfigFailed = 66,
    mEAutoConfigSuccess = 67,
    mEBootGuardHealthEvent = 68,
    mECpuDebugCapabilityDisabled = 69,
    mEDirectFlashUpdateRequested = 70,
    mEExceptionDuringShutdown = 71,
    mEFactoryResetError = 72,
    mEFactoryRestore = 73,
    mEFirmwareException = 74,
    mEFirmwarePanicReason = 75,
    mEFirmwareRecoveryReason = 76,
    mEFirmwareResiliencyError = 77,
    mEFlashEraseError = 78,
    mEFlashStateInformation = 79,
    mEFlashStateInformationWritingEnabled = 80,
    mEFlashVerificationError = 81,
    mEFlashWearOutWarning = 82,
    mEImageExecutionFailed = 83,
    mEInternalError = 84,
    mEManufacturingError = 85,
    mEMctpInterfaceError = 86,
    mEMultiPchModeMisconfig = 87,
    mEPeciOverDmiError = 88,
    mEPttHealthEvent = 89,
    mERecoveryGpioForced = 90,
    mERestrictedMode = 91,
    mESmbusLinkFailure = 92,
    mEUmaError = 93,
    mEUnsupportedFeature = 94,
    manufacturingModeEntered = 95,
    manufacturingModeExited = 96,
    memoryECCCorrectable = 97,
    memoryECCUncorrectable = 98,
